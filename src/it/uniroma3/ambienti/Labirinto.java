...
public class Labirinto {
	...
	public static class LabirintoBuilder {
        ...
        public LabirintoBuilder addStanzaIniziale(String nome) {
            // stesso codice del builder vecchio
            return this;
        }
	  ...
	  //crea gli attrezzi 
		  Attrezzo lanterna = new Attrezzo("lanterna",3); Attrezzo
	  osso = new Attrezzo("osso",1);
	  
	  //crea stanze del labirinto 
	  Stanza atrio = new Stanza("Atrio"); Stanza aulaN11
	  ...
	  stanzaIniziale = atrio; stanzaVincente =
	  biblioteca; }
